...
public class DictDetailController {
    ...
    public ResponseEntity<Object> query(DictDetailQueryCriteria criteria,
    	...
    	Map<String, Object> map = dictDetailService.queryAll(criteria,pageable);
    ...
    /**
     * 接口文档里测试
     * dictName : job_status,user_status
     * @param dictName
     * @return
     */
    ...
    public ResponseEntity<Object> getDictDetailMaps(@RequestParam String dictName){
        ...
        for (String name : names) {
        	...
        	List<DictDetail> list = dictDetailService.getDictByName(name);
        	list.forEach(dictDetail -> {
        		Dict d = new Dict();
        		d.setId(dictDetail.getDictId());
        		dictDetail.setDict(d);
        	});
            dictMap.put(name, list);
        }
    ...
    public ResponseEntity<Object> update(@RequestBody DictDetail resources){
