...
<div style="height: auto;
  ...
  font-size: 12px">
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="https://github.com/larrychen8276/xuecms" target="_blank">EL-ADMIN</a> 后台管理系统 All Rights Reserved.
        </div>
